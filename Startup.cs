using TMLS.APIFramework.Infrastructure.Configs;
using TMLS.APIFramework.Infrastructure.Extensions;
...
namespace TMLS.APIFramework
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "TMLS.APIFramework ASP.NET Core API v1");
            });
