...
namespace TMLS.APIFramework.Infrastructure.Extensions
{
    public static class TypeConverterExtension
    {
        ...
        public static DateTime? ToNullableDateTime(this string value)
              => !string.IsNullOrEmpty((value ?? "").Trim()) ? (DateTime?)null : (DateTime?)null;
